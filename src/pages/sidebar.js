import loadgetName from "../functions/getName";
import loadHome from "./home";
import loadProjectsPage from "./projects";
import loadTasksPage from "./tasks";
...
const sidebar = () => {
    ...
    sidebar.className = "sidebar";
        ...
        homeButton.addEventListener("click", (e) => loadHome());
        ...
        tasksButton.addEventListener("click", (e) => loadTasksPage());
        ...
        projectsButton.addEventListener("click", (e) => loadProjectsPage());
